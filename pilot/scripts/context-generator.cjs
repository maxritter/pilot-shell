"use strict";var It=Object.create;var $=Object.defineProperty;var Rt=Object.getOwnPropertyDescriptor;var Lt=Object.getOwnPropertyNames;var yt=Object.getPrototypeOf,Nt=Object.prototype.hasOwnProperty;var Ct=(r,e)=>{for(var t in e)$(r,t,{get:e[t],enumerable:!0})},ie=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Lt(e))!Nt.call(r,n)&&n!==t&&$(r,n,{get:()=>e[n],enumerable:!(s=Rt(e,n))||s.enumerable});return r};var C=(r,e,t)=>(t=r!=null?It(yt(r)):{},ie(e||!r||!r.__esModule?$(t,"default",{value:r,enumerable:!0}):t,r)),At=r=>ie($({},"__esModule",{value:!0}),r);var Gt={};Ct(Gt,{generateContext:()=>oe});module.exports=At(Gt);var Ot=C(require("path"),1),St=require("fs");var Te=require("bun:sqlite");var b=require("path"),le=require("os"),M=require("fs");var ue=require("url");var I=require("fs"),j=require("path"),ce=require("os");var ae="bugfix,feature,refactor,discovery,decision,change",de="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var A=class{static LEGACY_SKIP_TOOLS_DEFAULT="ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion";static DEFAULTS={CLAUDE_PILOT_MODEL:"haiku",CLAUDE_PILOT_CONTEXT_OBSERVATIONS:"50",CLAUDE_PILOT_WORKER_PORT:"41777",CLAUDE_PILOT_WORKER_HOST:"127.0.0.1",CLAUDE_PILOT_WORKER_BIND:"127.0.0.1",CLAUDE_PILOT_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion,Read,Grep,Glob,NotebookRead,WebSearch,WebFetch,ToolSearch,TaskCreate,TaskUpdate,TaskList,TaskGet,TaskOutput,TaskStop,ScheduleWakeup,ShareOnboardingGuide",CLAUDE_PILOT_DATA_DIR:(0,j.join)((0,ce.homedir)(),".pilot/memory"),CLAUDE_PILOT_LOG_LEVEL:"INFO",CLAUDE_PILOT_PYTHON_VERSION:"3.12",CLAUDE_CODE_PATH:"",CLAUDE_PILOT_CONTEXT_SHOW_READ_TOKENS:!1,CLAUDE_PILOT_CONTEXT_SHOW_WORK_TOKENS:!1,CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_AMOUNT:!1,CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_PERCENT:!1,CLAUDE_PILOT_CONTEXT_OBSERVATION_TYPES:ae,CLAUDE_PILOT_CONTEXT_OBSERVATION_CONCEPTS:de,CLAUDE_PILOT_CONTEXT_FULL_COUNT:"10",CLAUDE_PILOT_CONTEXT_FULL_FIELD:"facts",CLAUDE_PILOT_CONTEXT_SESSION_COUNT:"10",CLAUDE_PILOT_CONTEXT_SHOW_LAST_SUMMARY:!0,CLAUDE_PILOT_CONTEXT_SHOW_LAST_MESSAGE:!0,CLAUDE_PILOT_CONTEXT_MAX_CHARS:"9000",CLAUDE_PILOT_FOLDER_CLAUDEMD_ENABLED:!1,CLAUDE_PILOT_FOLDER_MD_EXCLUDE:"[]",CLAUDE_PILOT_CHROMA_ENABLED:!0,CLAUDE_PILOT_VECTOR_DB:"chroma",CLAUDE_PILOT_EMBEDDING_MODEL:"Xenova/all-MiniLM-L6-v2",CLAUDE_PILOT_EXCLUDE_PROJECTS:"[]",CLAUDE_PILOT_REMOTE_TOKEN:"",CLAUDE_PILOT_RETENTION_ENABLED:!0,CLAUDE_PILOT_RETENTION_MAX_AGE_DAYS:"31",CLAUDE_PILOT_RETENTION_MAX_COUNT:"5000",CLAUDE_PILOT_RETENTION_EXCLUDE_TYPES:'["summary"]',CLAUDE_PILOT_RETENTION_SOFT_DELETE:!1,CLAUDE_PILOT_BATCH_SIZE:"5",CLAUDE_PILOT_VECTOR_DB_MAX_PHYSICAL_MB:"2048",CLAUDE_PILOT_VECTOR_DB_MAX_LOGICAL_MB:"51200"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,I.existsSync)(e)){let d=this.getAllDefaults();try{let l=(0,j.dirname)(e);(0,I.existsSync)(l)||(0,I.mkdirSync)(l,{recursive:!0}),(0,I.writeFileSync)(e,JSON.stringify(d,null,2),"utf-8"),console.error("[SETTINGS] Created settings file with defaults:",e)}catch(l){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,l)}return d}let t=(0,I.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,I.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.error("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(d){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,d)}}let o=["CLAUDE_PILOT_CONTEXT_SHOW_READ_TOKENS","CLAUDE_PILOT_CONTEXT_SHOW_WORK_TOKENS","CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_AMOUNT","CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_PERCENT","CLAUDE_PILOT_CONTEXT_SHOW_LAST_SUMMARY","CLAUDE_PILOT_CONTEXT_SHOW_LAST_MESSAGE","CLAUDE_PILOT_FOLDER_CLAUDEMD_ENABLED","CLAUDE_PILOT_CHROMA_ENABLED","CLAUDE_PILOT_RETENTION_ENABLED","CLAUDE_PILOT_RETENTION_SOFT_DELETE"],i={...this.DEFAULTS},a=!1;for(let d of Object.keys(this.DEFAULTS))if(n[d]!==void 0)if(o.includes(d)){let l=n[d];typeof l=="string"?(i[d]=l==="true",a=!0):i[d]=l}else i[d]=n[d];if(a)try{(0,I.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.error("[SETTINGS] Migrated boolean settings from strings to actual booleans:",e)}catch(d){console.warn("[SETTINGS] Failed to auto-migrate boolean settings:",e,d)}if(i.CLAUDE_PILOT_SKIP_TOOLS===this.LEGACY_SKIP_TOOLS_DEFAULT){i.CLAUDE_PILOT_SKIP_TOOLS=this.DEFAULTS.CLAUDE_PILOT_SKIP_TOOLS;try{(0,I.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.error("[SETTINGS] Upgraded CLAUDE_PILOT_SKIP_TOOLS to expanded default:",e)}catch(d){console.warn("[SETTINGS] Failed to persist CLAUDE_PILOT_SKIP_TOOLS upgrade:",e,d)}}return i}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.getAllDefaults()}}};var Mt={};function vt(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ue.fileURLToPath)(Mt.url))}var zt=vt(),L=A.get("CLAUDE_PILOT_DATA_DIR");function X(r){return process.env.CLAUDE_CONFIG_DIR||(0,b.join)(r||(0,le.homedir)(),".claude")}function pe(r){return(0,b.join)(X(r),"projects")}var B=X(),Qt=(0,b.join)(L,"archives"),Zt=(0,b.join)(L,"logs"),es=(0,b.join)(L,"trash"),ts=(0,b.join)(L,"backups"),ss=(0,b.join)(L,"modes"),rs=(0,b.join)(L,"settings.json"),me=(0,b.join)(L,"pilot-memory.db"),ns=(0,b.join)(L,"vector-db"),os=(0,b.join)(B,"settings.json"),is=(0,b.join)(B,"CLAUDE.md"),as=(0,b.join)(B,".credentials.json"),Dt=(0,b.join)(B,"plugins"),ds=(0,b.join)(Dt,"marketplaces","pilot");function _e(r){(0,M.mkdirSync)(r,{recursive:!0})}var y=require("fs"),k=require("path"),ge=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),Ee=(0,k.join)((0,ge.homedir)(),".pilot/memory"),z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,k.join)(Ee,"logs");(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,k.join)(e,`pilot-memory-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,k.join)(Ee,"settings.json");if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_PILOT_LOG_LEVEL||"INFO").toUpperCase();this.level=J[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=J[e].padEnd(5),d=t.padEnd(6),l="";n?.correlationId?l=`[${n.correlationId}] `:n?.sessionId&&(l=`[session-${n.sessionId}] `);let u="";o!=null&&(o instanceof Error?u=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?u=`
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let p="";if(n){let{sessionId:_,memorySessionId:g,correlationId:O,...T}=n;Object.keys(T).length>0&&(p=` {${Object.entries(T).map(([f,S])=>`${f}=${S}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${l}${s}${p}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,E+`
`,"utf8")}catch(_){process.stderr.write(`[LOGGER] Failed to write to log file: ${_}
`),this.logFilePath=null}else process.stderr.write(E+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}error(e,t,s,n){this.log(3,e,t,s,n)}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}timing(e,t,s,n){this.info(e,`\u23F1 ${t}`,n,{duration:`${s}ms`})}happyPathError(e,t,s,n,o=""){let l=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=l?`${l[1].split("/").pop()}:${l[2]}`:"unknown",p={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),o}},m=new z;var W=class{db;constructor(e=me){e!==":memory:"&&_e(L),this.db=new Te.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.ensureSessionPlansTable(),this.createProjectRootsTable(),this.ensureNotificationsTable(),this.addSessionAgentColumn(),this.addObservationSharedColumns()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,l=s==="date_asc"?"ASC":"DESC",u=n!=null?Math.trunc(Number(n)):void 0,p=u&&u>0?"LIMIT ?":"",E=e.map(()=>"?").join(","),_=[...e],g=[];if(o&&(g.push("project = ?"),_.push(o)),i)if(Array.isArray(i)){let h=i.map(()=>"?").join(",");g.push(`type IN (${h})`),_.push(...i)}else g.push("type = ?"),_.push(i);if(a){let h=Array.isArray(a)?a:[a],f=h.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");_.push(...h),g.push(`(${f.join(" OR ")})`)}if(d){let h=Array.isArray(d)?d:[d],f=h.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");h.forEach(S=>{_.push(`%${S}%`,`%${S}%`)}),g.push(`(${f.join(" OR ")})`)}let O=g.length>0?`WHERE id IN (${E}) AND ${g.join(" AND ")}`:`WHERE id IN (${E})`;return u&&u>0&&_.push(u),this.db.prepare(`
      SELECT *
      FROM observations
      ${O}
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),l=new Date(d).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `),p;try{p=u.run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,l,d,a?.uid??null,a?.author??null)}catch(E){if(a){let _=this.findObservationBySharedUid(a.uid);if(_)return{id:_.id,createdAtEpoch:d}}throw E}return{id:Number(p.lastInsertRowid),createdAtEpoch:d}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),l=new Date(d).toISOString();return this.db.transaction(()=>{let p=[],E=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let O=E.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),o||null,i,l,d);p.push(Number(O.lastInsertRowid))}let _=null;if(n){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,l,d);_=Number(O.lastInsertRowid)}return{observationIds:p,summaryId:_,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,l){let u=l??Date.now(),p=new Date(u).toISOString();return this.db.transaction(()=>{let _=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let h of s){let f=g.run(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),a||null,d,p,u);_.push(Number(f.lastInsertRowid))}let O;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
Do not output anything other than the summary content formatted in the XML structure above.`}},R=class r{static instance=null;activeMode=null;constructor(){}static getInstance(){return r.instance||(r.instance=new r),r.instance}loadMode(){return this.activeMode=Ie,Ie}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getObservationConcepts(){return this.getActiveMode().observation_concepts}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}validateType(e){return this.getObservationTypes().some(t=>t.id===e)}getTypeLabel(e){return this.getObservationTypes().find(s=>s.id===e)?.label||e}};function Z(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/Se)}function ee(r){let e=r.length,t=r.reduce((i,a)=>i+Z(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function wt(r){return R.getInstance().getWorkEmoji(r)}function v(r,e){let t=Z(r),s=r.discovery_tokens||0,n=wt(r.type),o=s>0?`${n} ${s.toLocaleString()}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function H(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}var Re=C(require("path"),1),G=require("fs");function Le(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,...s,...o,t.totalObservationCount)}function ye(r,e,t){return r.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch
    FROM session_summaries
    WHERE project = ?
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+w)}function Ne(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Ce(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+w)}function Ae(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
    ...
    LIMIT ?
  `).all(e,...n,...i,s,t.totalObservationCount)}function ve(r,e,t,s){return r.db.prepare(`
    ...
    LIMIT ?
  `).all(e,s,t.sessionCount+w)}function De(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id, o.memory_session_id, o.type, o.title, o.subtitle, o.narrative,
      o.facts, o.concepts, o.files_read, o.files_modified, o.discovery_tokens,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...n,...i,s,t.totalObservationCount)}function Me(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT ss.id, ss.memory_session_id, ss.request, ss.investigated, ss.learned,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,s,t.sessionCount+w)}function xt(r){return r.replace(new RegExp("/","g"),"-")}function Ut(r){try{if(!(0,G.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,G.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),a){s=a;break}}}catch(o){m.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return m.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function ke(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=xt(s),a=Re.default.join(pe(),i,`${o}.jsonl`);return Ut(a)}function we(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function te(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function xe(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Ue(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Pe(r){return[`# [${r}] recent context, ${Ue()}`,""]}function Fe(){return[`**Legend:** session-request | ${R.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ")}`,""]}function $e(){return["**Column Key**:","- **Read**: Tokens to read this observation (cost to learn it now)","- **Work**: Tokens spent on work that produced this record ( research, building, deciding)",""]}function je(){return["**Context Index:** titles, types, and files of recent work in this project. It tells you what was done and decided; it does not tell you the current state of the code, so verify against the files before building on it.","","When you need implementation details, rationale, or debugging context:","- Use MCP tools (search, get_observations) to fetch full observations on-demand",'- If the mem-search MCP server is unavailable, run `bun ~/.pilot/scripts/worker-service.cjs search "<query>" --json`',"- Bugfix and decision records usually need the full observation, not just the title",""]}function Xe(r,e){let t=[];if(t.push("**Context Economics**:"),t.push(`- Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)`),t.push(`- Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="- Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(s)}return t.push(""),t}function se(r){return[`### ${r}`,""]}function Be(r){return[`**${r}**`,"| ID | Time | T | Title | Read | Work |","|----|------|---|-------|------|------|"]}function We(r,e,t){let s=r.title||"Untitled",n=R.getInstance().getTypeIcon(r.type),{readTokens:o,discoveryDisplay:i}=v(r,t),a=t.showReadTokens?`~${o}`:"",d=t.showWorkTokens?i:"";return`| #${r.id} | ${e||'"'} | ${n} | ${s} | ${a} | ${d} |`}function He(r,e,t,s){let n=[],o=r.title||"Untitled",i=R.getInstance().getTypeIcon(r.type),{readTokens:a,discoveryDisplay:d}=v(r,s);n.push(`**#${r.id}** ${e||'"'} ${i} **${o}**`),t&&(n.push(""),n.push(t),n.push(""));let l=[];return s.showReadTokens&&l.push(`Read: ~${a}`),s.showWorkTokens&&l.push(`Work: ${d}`),l.length>0&&n.push(l.join(", ")),n.push(""),n}function Ge(r,e){let t=`${r.request||"Session started"} (${e})`;return[`**#S${r.id}** ${t}`,""]}function x(r,e){return e?[`**${r}**: ${e}`,""]:[]}function Ye(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Ve(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use MCP search tools to access memories by ID.`]}function qe(r){return`# [${r}] recent context, ${Ue()}

No previous sessions found for this project yet.`}function Ke(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Je(r){return["",`${c.bright}${c.cyan}[${r}] recent context, ${Ke()}${c.reset}`,`${c.gray}${"\u2500".repeat(60)}${c.reset}`,""]}function ze(){let e=R.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${c.dim}Legend: session-request | ${e}${c.reset}`,""]}function Qe(){return[`${c.bright}Column Key${c.reset}`,`${c.dim}  Read: Tokens to read this observation (cost to learn it now)${c.reset}`,`${c.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${c.reset}`,""]}function Ze(){return[`${c.dim}Context Index: titles, types, and files of recent work in this project. It tells you what was done and decided; it does not tell you the current state of the code, so verify against the files before building on it.${c.reset}`,"",`${c.dim}When you need implementation details, rationale, or debugging context:${c.reset}`,`${c.dim}  - Use MCP tools (search, get_observations) to fetch full observations on-demand${c.reset}`,`${c.dim}  - If the mem-search MCP server is unavailable, run: bun ~/.pilot/scripts/worker-service.cjs search "<query>" --json${c.reset}`,`${c.dim}  - Bugfix and decision records usually need the full observation, not just the title${c.reset}`,""]}function et(r,e){let t=[];if(t.push(`${c.bright}${c.cyan}Context Economics${c.reset}`),t.push(`${c.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${c.reset}`),t.push(`${c.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${c.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${c.green}${s}${c.reset}`)}return t.push(""),t}function re(r){return[`${c.bright}${c.cyan}${r}${c.reset}`,""]}function tt(r){return[`${c.dim}${r}${c.reset}`]}function st(r,e,t,s){let n=r.title||"Untitled",o=R.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=v(r,s),l=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),u=s.showReadTokens&&i>0?`${c.dim}(~${i}t)${c.reset}`:"",p=s.showWorkTokens&&a>0?`${c.dim}(${d} ${a.toLocaleString()}t)${c.reset}`:"";return`  ${c.dim}#${r.id}${c.reset}  ${l}  ${o}  ${n} ${u} ${p}`}function rt(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=R.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:l,workEmoji:u}=v(r,n),p=t?`${c.dim}${e}${c.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${c.dim}(~${d}t)${c.reset}`:"",_=n.showWorkTokens&&l>0?`${c.dim}(${u} ${l.toLocaleString()}t)${c.reset}`:"";return o.push(`  ${c.dim}#${r.id}${c.reset}  ${p}  ${a}  ${c.bright}${i}${c.reset}`),s&&o.push(`    ${c.dim}${s}${c.reset}`),(E||_)&&o.push(`    ${E} ${_}`),o.push(""),o}function nt(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${c.yellow}#S${r.id}${c.reset} ${t}`,""]}function U(r,e,t){return e?[`${t}${r}:${c.reset} ${e}`,""]:[]}function ot(r){return r.assistantMessage?["","---","",`${c.bright}${c.magenta}Previously${c.reset}`,"",`${c.dim}A: ${r.assistantMessage}${c.reset}`,""]:[]}function it(r,e){let t=Math.round(r/1e3);return["",`${c.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use MCP search tools to access memories by ID.${c.reset}`]}function at(r){return`
...
`}function dt(r,e,t,s){let n=[];return s?n.push(...Je(r)):n.push(...Pe(r)),s?n.push(...ze()):n.push(...Fe()),(t.showReadTokens||t.showWorkTokens)&&(s?n.push(...Qe()):n.push(...$e())),s?n.push(...Ze()):n.push(...je()),H(t)&&(s?n.push(...et(e,t)):n.push(...Xe(e,t))),n}var ne=C(require("path"),1);function q(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function lt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ut(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function pt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ct(r,e){return ne.default.isAbsolute(r)?ne.default.relative(e,r):r}function mt(r,e,t){let s=q(r);if(s.length>0)return ct(s[0],e);if(t){let n=q(t);if(n.length>0)return ct(n[0],e)}return"General"}function Pt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=pt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Ft(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?q(r.facts).join(`
`):null}function _t(r,e,t,s,n,o){let i=[];o?i.push(...re(r)):i.push(...se(r));let a=null,d="",l=!1;for(let u of e)if(u.type==="summary"){l&&(i.push(""),l=!1,a=null,d="");let p=u.data,E=lt(p.displayTime);o?i.push(...nt(p,E)):i.push(...Ge(p,E))}else{let p=u.data,E=mt(p.files_modified,n,p.files_read),_=ut(p.created_at),g=_!==d,O=g?_:"";d=_;let T=t.has(p.id);if(E!==a&&(l&&i.push(""),o?i.push(...tt(E)):i.push(...Be(E)),a=E,l=!0),T){let h=Ft(p,s);o?i.push(...rt(p,_,g,h,s)):(l&&!o&&(i.push(""),l=!1),i.push(...He(p,O,h,s)),a=null)}else o?i.push(st(p,_,g,s)):i.push(We(p,O,s))}return l&&i.push(""),i}function $t(r,e){return e?re(r):se(r)}function Et(r,e,t,s,n){let o=[],i=Pt(r);for(let[a,d]of i){let l=$t(a,n);o.push({day:a,itemCount:d.length,lines:_t(a,d,e,t,s,n),headerLines:l,itemBlocks:d.map(u=>_t(a,[u],e,t,s,n).slice(l.length))})}return o}function D(r){return r.join(`
`).length}function jt(r){return[`_${r} older ${r===1?"entry":"entries"} omitted to fit the session-start budget; search memory for them._`,""]}var P="_Additional recent context omitted to fit the session-start budget._";function F(r){return r>0?jt(r):[]}function K(r,e){let t=r.flatMap(n=>n.split(`
`));if(e<=0||D(t)<=e)return t;if(e<=P.length)return[P.slice(0,e)];let s=[];for(let n of t){if(D([...s,n,P])<=e){s.push(n);continue}let o=D(s),i=s.length>0?2:1,a=e-o-i-P.length;return a>1&&s.push(`${n.slice(0,a-1)}\u2026`),s.push(P),s}return s}function gt(r,e,t,s){let n=[...r,...e.flatMap(p=>p.lines),...t];if(s<=0||D(n)<=s)return n;let o=e.reduce((p,E)=>p+E.itemCount,0);if(e.length===0)return K([...r,...t],s);let i=[],a=0;for(let p=e.length-1;p>=0;p--){let E=[e[p],...i],_=o-a-e[p].itemCount,g=[...r,...F(_),...E.flatMap(O=>O.lines),...t];if(D(g)>s)break;i.unshift(e[p]),a+=e[p].itemCount}if(i.length>0)return K([...r,...F(o-a),...i.flatMap(p=>p.lines),...t],s);let d=e[e.length-1],l=d.itemBlocks??[],u=[];for(let p=l.length-1;p>=0;p--){let E=[l[p],...u],_=o-E.length,g=[...r,...F(_),...d.headerLines??[],...E.flat(),...t];if(D(g)>s)break;u.unshift(l[p])}return u.length>0?K([...r,...F(o-u.length),...d.headerLines??[],...u.flat(),...t],s):K([...r,...F(o),...t],s)}function Tt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ht(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,c.blue)),t.push(...U("Learned",r.learned,c.yellow)),t.push(...U("Completed",r.completed,c.green)),t.push(...U("Next Steps",r.next_steps,c.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function ft(r,e){return e?ot(r):Ye(r)}function bt(r,e,t){return!H(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?it(r.totalDiscoveryTokens,r.totalReadTokens):Ve(r.totalDiscoveryTokens,r.totalReadTokens)}var Xt=Ot.default.join(X(),"plugins","marketplaces","pilot","plugin",".install-version");function Bt(){try{return new W}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,St.unlinkSync)(Xt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Wt(r,e){return e?at(r):qe(r)}function Ht(r,e,t,s,n,o,i){let a=[],d=ee(e);a.push(...dt(r,d,s,i));let l=t.slice(0,s.sessionCount),u=we(l,t),p=te(e,u),E=xe(e,s.fullObservationCount),_=Et(p,E,s,n,i),g=t[0],O=e[0],T=[];Tt(s,g,O)&&T.push(...ht(g,i));let h=ke(e,s,o,n);return T.push(...ft(h,i)),T.push(...bt(d,s,i)),gt(a,_,T,s.maxChars).join(`
`).trimEnd()}async function oe(r,e=!1){let t=Oe(),s=r?.cwd??process.cwd(),n=he(s),o=r?.projects||[n],i=Bt();if(!i)return"";try{let a=r?.planPath,d,l;return a?(d=o.length>1?De(i,o,t,a):Ae(i,n,t,a),l=o.length>1?Me(i,o,t,a):ve(i,n,t,a)):(d=o.length>1?Ne(i,o,t):Le(i,n,t),l=o.length>1?Ce(i,o,t):ye(i,n,t)),d.length===0&&l.length===0?Wt(n,e):Ht(n,d,l,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
