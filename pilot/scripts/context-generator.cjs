...
Do not output anything other than the summary content formatted in the XML structure above.`}},R=class r{static instance=null;activeMode=null;constructor(){}static getInstance(){return r.instance||(r.instance=new r),r.instance}loadMode(){return this.activeMode=Ee,Ee}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getObservationConcepts(){return this.getActiveMode().observation_concepts}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}validateType(e){return this.getObservationTypes().some(t=>t.id===e)}getTypeLabel(e){return this.getObservationTypes().find(s=>s.id===e)?.label||e}};function q(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/_e)}function K(r){let e=r.length,t=r.reduce((i,a)=>i+q(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function Ct(r){return R.getInstance().getWorkEmoji(r)}function v(r,e){let t=q(r),s=r.discovery_tokens||0,n=Ct(r.type),o=s>0?`${n} ${s.toLocaleString()}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function j(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}var ge=C(require("path"),1),Te=require("os"),X=require("fs");function he(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
  ...
  `).all(e,...s,...o,t.totalObservationCount)}function fe(r,e,t){return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+M)}function be(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Oe(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+M)}function Se(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
  ...
  `).all(e,...n,...i,s,t.totalObservationCount)}function Ie(r,e,t,s){return r.db.prepare(`
    ...
    LIMIT ?
  `).all(e,s,t.sessionCount+M)}function Re(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id, o.memory_session_id, o.type, o.title, o.subtitle, o.narrative,
      o.facts, o.concepts, o.files_read, o.files_modified, o.discovery_tokens,
...
`}function rt(r,e,t,s){let n=[];return s?n.push(...Be(r)):n.push(...ve(r)),s?n.push(...Ge()):n.push(...De()),s?n.push(...Ye()):n.push(...Me()),s?n.push(...Ve()):n.push(...xe()),j(t)&&(s?n.push(...qe(e,t)):n.push(...ke(e,t))),n}var z=C(require("path"),1);function B(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ot(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function at(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function nt(r,e){return z.default.isAbsolute(r)?z.default.relative(e,r):r}function dt(r,e,t){let s=B(r);if(s.length>0)return nt(s[0],e);if(t){let n=B(t);if(n.length>0)return nt(n[0],e)}return"General"}function Dt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=at(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Mt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?B(r.facts).join(`
`):null}function xt(r,e,t,s,n,o){let i=[];o?i.push(...Ke(r)):i.push(...we(r));let a=null,d="",l=!1;for(let u of e)if(u.type==="summary"){l&&(i.push(""),l=!1,a=null,d="");let p=u.data,g=ot(p.displayTime);o?i.push(...Ze(p,g)):i.push(...$e(p,g))}else{let p=u.data,g=dt(p.files_modified,n,p.files_read),_=it(p.created_at),E=_!==d,O=E?_:"";d=_;let T=t.has(p.id);if(g!==a&&(l&&i.push(""),o?i.push(...Je(g)):i.push(...Ue(g)),a=g,l=!0),T){let h=Mt(p,s);o?i.push(...Qe(p,_,E,h,s)):(l&&!o&&(i.push(""),l=!1),i.push(...Fe(p,O,h,s)),a=null)}else o?i.push(ze(p,_,E,s)):i.push(Pe(p,O,s))}return l&&i.push(""),i}function ct(r,e,t,s,n){let o=[],i=Dt(r);for(let[a,d]of i)o.push(...xt(a,d,e,t,s,n));return o}function lt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ut(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,c.blue)),t.push(...k("Learned",r.learned,c.yellow)),t.push(...k("Completed",r.completed,c.green)),t.push(...k("Next Steps",r.next_steps,c.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function pt(r,e){return e?et(r):je(r)}function mt(r,e,t){return!j(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?tt(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}var kt=_t.default.join((0,Et.homedir)(),".claude","plugins","marketplaces","pilot","plugin",".install-version");function wt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,gt.unlinkSync)(kt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ut(r,e){return e?st(r):We(r)}function Pt(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...rt(r,d,s,i));let l=t.slice(0,s.sessionCount),u=Ne(l,t),p=J(e,u),g=Ce(e,s.fullObservationCount);a.push(...ct(p,g,s,n,i));let _=t[0],E=e[0];lt(s,_,E)&&a.push(...ut(_,i));let O=ye(e,s,o,n);return a.push(...pt(O,i)),a.push(...mt(d,s,i)),a.join(`
`).trimEnd()}async function Q(r,e=!1){let t=me(),s=r?.cwd??process.cwd(),n=le(s),o=r?.projects||[n],i=wt();if(!i)return"";try{let a=r?.planPath,d,l;return a?(d=o.length>1?Re(i,o,t,a):Se(i,n,t,a),l=o.length>1?Le(i,o,t,a):Ie(i,n,t,a)):(d=o.length>1?be(i,o,t):he(i,n,t),l=o.length>1?Oe(i,o,t):fe(i,n,t)),d.length===0&&l.length===0?Ut(n,e):Pt(n,d,l,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
