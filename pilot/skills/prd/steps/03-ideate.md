## Step 3: Ideate (Optional — Skip if Concrete)
...
Then proceed to Step 4 (Clarify) with `AskUserQuestion`.
...
- **Using `AskUserQuestion` here.** Structured forms collapse divergent thinking. Save them for Step 4.
