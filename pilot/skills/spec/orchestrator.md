...
> **Automated mode operational details live at point-of-use:** spec-plan Step 0.1a (EnterPlanMode) and Step 12.3 (ExitPlanMode after approval — a model switch, NOT approval). ⛔ No mode ends its turn between approval and implementation — see Step 12.3 and `task-and-workflow.md`.
>
